...
import funkin.objects.input.InputFormatter;
import funkin.objects.menu.AttachedText
import funkin.objects.options.CheckBoxThingie;
import funkin.objects.options.Option;
