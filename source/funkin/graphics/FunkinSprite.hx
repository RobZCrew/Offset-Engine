...
// TIP: You can set animPaused to true if you want the animation to pause
class FunkinSprite extends FlxSkewedSprite {
    ...
    public function new(x:Float = 0, y:Float = 0, key:String = '', ?type:SpriteType = NORMAL) {
        super(x, y);
    ...
    /*public function createAtlas(key:String) {
        ...
        try {
            isAnimateAtlas = true;
            Paths.loadAnimateAtlas(atlas, key);
