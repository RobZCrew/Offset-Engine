...
class StoryMenuState extends MusicBeatState {
	public var weekData:Array<Dynamic> = [
		['Tutorial'],
	...
	override function create() {
	 #if MODS_ALLOWED
		weekData.push(Mods.getSongsList());
		weekUnlocked.push(true);
		weekCharacters.push(['bf', 'bf', 'bf']);
		weekNames.push('');
		#end
	...
	function selectWeek() {
		if (weekUnlocked[curWeek]) {
			...
			PlayState.SONG = Chart.loadFromJson(PlayState.storyPlaylist[0].toLowerCase() + diffic, PlayState.storyPlaylist[0].toLowerCase());
