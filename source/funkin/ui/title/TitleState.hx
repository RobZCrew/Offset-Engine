...
class TitleState extends MusicBeatState
{
	...
	override public function create():Void
	{
		...
		#elseif CHARTING
		MusicBeatState.switchState(new funkin.editors.ChartingState());
		#else
	...
	function startIntro()
	{
		if (!initialized)
		{
			...
			// music.play();
			FlxG.sound.playMusic(Paths.music('assets/music/freakyMenu'), 0);
	...
	{
		var fullText:String = Assets.getText(Paths.file('data/introText.txt'));
